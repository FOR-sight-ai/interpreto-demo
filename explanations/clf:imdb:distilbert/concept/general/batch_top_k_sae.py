...
inputs = load_dataset('stanfordnlp/imdb')['train'].shuffle(seed=SEED)["text"][:1000]
...
concept_explainer = BatchTopKSAEConcepts(model_with_split_points, nb_concepts=30, device=device)
