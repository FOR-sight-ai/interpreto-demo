...
from interpreto.concepts import BatchTopKSAEConcepts
...
dataset = load_dataset('dair-ai/emotion')['test'].shuffle(seed=0)
...
for target, class_name in enumerate(['sadness', 'joy', 'love', 'anger', 'fear', 'surprise']):
    ...
    concept_explainer = BatchTopKSAEConcepts(model_with_split_points, nb_concepts=20, device=device)
